    ...
    public static Connection conecta() {
        if (ConexaoOracle != null) {
            ...
            try {
                ...
                ConexaoOracle = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE", "provapoo2016", "provapoo2016");
        ...
        public void commit(){
            try {
                ...
                JOptionPane.showMessageDialog(null, "Problema ao tentar realizar Commit");
            }
        }
         ...
         public void rollback(){
            try {
                ...
                JOptionPane.showMessageDialog(null, "Problema ao tentar realizar Rollback");
            }
        }
